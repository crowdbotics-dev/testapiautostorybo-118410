...
## Project Structure
    ...
    ├── testapiautostorybo_118410  # Django project configurations
...
1. Clone this repo and `cd testapiautostorybo_118410`
...
2. Clone this repo and `cd testapiautostorybo_118410`
